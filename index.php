                    ...
                    foreach ($states as $state) {
                        ...
                        if (in_array($state, $states_visited)) {
                            if ($state == "Massachusetts") {
                                echo '<button class="state-button state-button-visited state-button-massachusetts" onclick="updateState(\'Massachusetts\', this)"';
                            } else {
                                echo '<button class="state-button state-button-visited" onclick="updateState(\'' . $state . '\', this)"';
                            }
                        } else {
                            if ($state == "Massachusetts") {
                                echo '<button class="state-button state-button-massachusetts" onclick="updateState(\'' . $state . '\', this)"';
                            }else{
